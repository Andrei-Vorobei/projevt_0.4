  ...
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(e => {
      ...
      if (document.body.offsetHeight > document.documentElement.clientHeight) {
        ...
        Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.modal').moveX(this.calcScroll());
      }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.marginRight = function (margin) {
  for (let i = 0; i < this.length; i++) {
    this[i].style.marginRight = `${margin}px`;
  }
};

_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.positionRight = function (right) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.on = function (eventName, callback) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.off = function (eventName, callback) {
  if (!eventName || !callback) {
    return this;
  }
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.click = function (handler) {
  for (let i = 0; i < this.length; i++) {
    if (handler) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.getAttr = function (attrName) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.removeAllAttrs = function () {
  for (let i = 0; i < this.length; i++) {
    let attributes = [];
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').eq(4).on('click', () => {
...
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.modal').getAttr('test'));
